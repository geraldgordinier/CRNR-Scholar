...
export const QUESTIONS_7: Question[] = [
  {
    id: '200b',
    category: 'Trauma',
    text: 'Which of the following is the most significant complication of strict glycemic control (80-110 mg/dL) in patients following severe traumatic brain injuries?',
    options: ['Worsening of the Glasgow Coma Scale score', 'Increased cerebral edema', 'Immunosuppression', 'Hypoglycemia'],
    correctAnswerIndex: 3,
    rationale: 'Hyperglycemia is common following the severe stress, including in traumatic brain injury (TBI) patients. Hyperglycemia is thought to worsen outcomes, but strict glycemic control (range 80-110 mg/dL) results in frequent hypoglycemic episodes.'
  },
  {
    id: '201',
    ...
    rationale: 'CP is not contagious. It is chronic without a known cure. It is not related to a genetic abnormality and cannot be passed along generation to generation.'
  },
  {
    id: '202',
    ...
    correctAnswerIndex: 0,
    rationale: 'Hypertension is considered the single most important risk factor of both ischemic and hemorrhagic strokes.'
  },
  {
    id: '203',
    category: 'Chronic/Degenerative',
    ...
    rationale: 'A ventriculoperitoneal (VP) shunt may be placed to manage the symptoms of normal-pressure hydrocephalus (NPH) including patient\'s gait and urinary continence.'
  },
  {
    id: '204',
    category: 'Trauma',
  ...
  },
  {
    ...
    correctAnswerIndex: 2,
    rationale: 'Tumors arising from the lungs commonly metastasize to the brain.'
  },
  {
    id: '206',
    category: 'Seizures',
  ...
  },
  {
    ...
    correctAnswerIndex: 3,
    rationale: 'The recommendation by the American Heart Association/American Stroke Association (AHA/ASA) is to initiate blood pressure (BP) therapy with antihypertensive agents for a systolic BP > 140 mmHg and diastolic > 90 mmHg.'
  },
  {
    id: '208',
    category: 'Tumors',
    ...
    correctAnswerIndex: 2,
    rationale: 'An anaplastic astrocytoma is a grade III astrocytoma. A glioblastoma is a grade IV astrocytoma.'
  },
  {
    id: '209',
    category: 'Trauma',
  ...
  },
  {
    ...
    correctAnswerIndex: 1,
    rationale: 'One of the known causes for cerebral palsy (CP) is maternal infection, such as Rubella (German measles), during pregnancy. Prevention of CP includes vaccinations.'
  },
  {
    id: '214',
    category: 'Trauma',
    ...
    correctAnswerIndex: 0,
    rationale: 'CN I, the olfactory cranial nerve, is commonly damaged due to shearing of the olfactory fibers at the cribriform plate during the trauma.'
  },
  {
    id: '215',
    category: 'Cerebrovascular',
    ...
    correctAnswerIndex: 0,
    rationale: 'Activating the EMS 9-1-1 system allows a more rapid transport to the hospital and allows for the prehospital identification of stroke symptoms.'
  },
  {
    id: '216',
    category: 'Trauma',
  ...
  },
  {
    ...
    correctAnswerIndex: 0,
    rationale: 'Pineal tumors commonly cause the obstruction of cerebrospinal fluid, resulting in noncommunicating hydrocephalus.'
  },
  {
    id: '218',
    category: 'Cerebrovascular',
    ...
    correctAnswerIndex: 1,
    rationale: 'Keep the definitions and explanations simple, at a fourth-grade level. Use common words and limit words with multiple syllables.'
  },
  {
    id: '219',
    category: 'Chronic/Degenerative',
  ...
  },
  {
    ...
    correctAnswerIndex: 3,
    rationale: 'Eating undercooked pork does not cause meningitis but can increase the risk of neurocysticercosis.'
  },
  {
    id: '221',
    category: 'Seizures',
    ...
    correctAnswerIndex: 0,
    rationale: 'Pyridoxine dependency can be caused by glutamic acid decarboxylase activity impairment. This is a rare autosomal recessive condition. Seizures can start immediately after birth or later.'
  },
  {
    id: '222',
    category: 'Chronic/Degenerative',
  ...
  },
  {
    ...
    correctAnswerIndex: 2,
    rationale: 'Patients often have difficulty accepting change, especially when it involves admitting decline of skills or changes to the home. When this occurs, the first step is to discuss the situation. If the patient is still resistant, the other options are appropriate.'
  },
  {
    id: '224',
    category: 'Chronic/Degenerative',
  ...
  },
  {
    ...
    correctAnswerIndex: 2,
    rationale: 'The most common causes, in order, of neonatal seizures in the first 12 hours are hypoxic/ischemic encephalopathy, sepsis, meningitis, and subarachnoid hemorrhage.'
  },
  {
    id: '228',
    category: 'Cerebrovascular',
  ...
  },
  {
    ...
    correctAnswerIndex: 2,
    rationale: 'Sharing any information about the patient is a violation of HIPAA. The best response is to encourage the colleague to visit the patient who can share as they see fit.'
  },
  {
    id: '230',
    category: 'Professional Issues',
    ...
    correctAnswerIndex: 1,
    rationale: 'It often takes 2 or more people to transfer morbidly obese patients. Trying to do so alone, even using proper body mechanics, can result in injury.'
  },
  {
    id: '231',
    category: 'Tumors',
    text: 'Which of the following choices is not true of neuroblastomas?',
    ...
    correctAnswerIndex: 0,
    rationale: 'They are masses which originate from the parasympathetic chain is FALSE. Neuroblastomas are tumors of the sympathetic chain.'
  },
  {
    id: '232',
    category: 'Trauma',
    text: 'How can you determine the vertebral level of a thoracic cord compression on a 24 cm field of view sagittal sequence?',
    options: ['Use the xiphoid process as a landmark. It is at the ninth thoracic level', 'Use the sternal notch as a landmark. It is at the T4-5 level', 'Take a single view lateral T-Spine radiograph.', 'Use the localizer\'s large field of view and count down from C2'],
    correctAnswerIndex: 3,
  ...
  },
  {
    ...
    options: ['57', '20', '13', '2'],
    correctAnswerIndex: 3,
    rationale: 'Lennox-Gastaut syndrome is associated with about 2 percent of seizures.'
  },
  {
    id: '234',
    category: 'Chronic/Degenerative',
    ...
    options: ['0', '1', '3', '5'],
    correctAnswerIndex: 3,
    rationale: 'No muscle movement is a grade zero. Grade 3 motor strength is movement against only gravity. Normal motor strength is grade 5.'
  },
  {
    id: '235',
    category: 'Seizures',
    ...
    correctAnswerIndex: 2,
    rationale: 'Juvenile myoclonic epilepsy usually has onset at puberty. It is characterized by myoclonic jerks which often occur in the early morning hours, but is not considered a progressive myoclonic epilepsy condition.'
  }
];
